...
/*
** Function add_nt added by Bart Janisse on 2015/04/11
*/
void
add_nt(char * s, int len)
{
    // add 0 terminator to a string
    s [len] = '\0';
}

/*
** Function invert_case added by Bart Janisse on 2015/04/11
*/
void
invert_case(char * s)
{
